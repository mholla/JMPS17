...
if __name__ == '__main__':
    ...
    for mode_type in ['FvK_compression ', 'FvK_growth ']:
        for modification in ['original', 'mod_both']:
    ...
    for n in range(len(modes)):
        ...
        for j in range(len(betas)):
            ...
            [strains_all, wavelengths_all] = find_critical_values(
                mode,
                beta,
                wavelengths,
                lam_min,
            ...
            [min_strains, min_wavelengths, min_betas, max_strains, max_wavelengths, max_betas] = find_threshold_values(
                beta,
                strains_all,
                wavelengths_all,
                min_strains,
